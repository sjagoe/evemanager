#ifndef __EVEAPISOVEREIGNTY_HH__
#define __EVEAPISOVEREIGNTY_HH__

#include "eveapirequest.hh"

class EveApiSovereignty: public EveApiRequest
{
    Q_OBJECT
    public:
        /*!
        ...
        */
        EveApiSovereignty( const QString& requestType, const QString& dataPath,
